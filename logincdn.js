class Login {
    ...
    //Configurações padrões para css e html.
    static config = {
        cor:"048",
        img:"./logo.png"
    };

    static endpoint = "https://login.karloskley.repl.co/";
    //https://login.karloskley.repl.co/?matricula=123&senha=321
    
    static login = (callback_ok, callback_naook, config=null) => {
        if(config!=null){//Se houver alguma configuração definida.
            this.config = config;
        }
        ...
        this.estilocss =
            ...
            ".elementosLogin{display: flex; justify-content: center; align-items: flex-start; flex-direction: column; width: 50%; background-color: #aaa; padding: 10px; border-radius: 10px 0px 0px 10px; box-sizing: inherit;}"+
            ".logoLogin{display: flex; justify-content: center; align-items: center; width: 50%; background-color: #aaa; padding: 10px; border-radius: 0px 10px 10px 0px; box-sizing: inherit;}"+
            ".logoLogin img{width: 250px;}"+
            ...
            `.botoesLogin button{cursor: pointer; background-color:#${this.config.cor}; color: #fff; border-radius: 10px; padding: 10px; width: 100px; box-sizing: inherit;}`
            ...
            document.body.prepend(fundoLogin); //prepend para adicionar no início.
            ...
            imgLogoLogin.setAttribute("title", "Prof. Carlos Klei");
    ...
    static verificaLogin=()=>{
        ...
        const endpoint = `https://login.karloskley.repl.co/?matricula=${mat}&senha=${pas}`
